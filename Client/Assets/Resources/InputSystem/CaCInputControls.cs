...
namespace ScotlandYard.InputSystem
{
    ...
    ""controlSchemes"": [
        ...
        ~@CaCInputControls()
        {
            UnityEngine.Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, CaCInputControls.UI.Disable() has not been called.");
            UnityEngine.Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, CaCInputControls.Player.Disable() has not been called.");
        }
